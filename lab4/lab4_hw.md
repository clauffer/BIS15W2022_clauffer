...
```
The largest deer of the genus alces or commonly known as the moose.
...
```
The snake with the smallest homerange is the namaqua dwarf adder. It is the worlds smallest viper and one of the smallest snakes in the genus Bitis. It inhabits near the Namib desert.
