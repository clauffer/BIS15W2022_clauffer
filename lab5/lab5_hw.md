...
##           hair_color height         publisher     skin_color alignment weight
...
## 2 Doctor Doom   Male     brown Human      Brown    201 Marvel Comics       <NA>
## 3     Kingpin   Male      blue Human    No Hair    201 Marvel Comics       <NA>
## 4      Lizard   Male       red Human    No Hair    203 Marvel Comics       <NA>
## 5    Scorpion   Male     brown Human      Brown    211 Marvel Comics       <NA>
##   alignment weight
## 1       bad    180
## 2       bad    187
## 3       bad    203
...
More good guys are bald (37) compared to bad guys(35).
...
Not sure if we were supposed to keep weight so did both.
...
Because we are doing an OR search so it means we will get more results.
...
##   name   gender eye_color race  hair_color height publisher skin_color alignment
##   <chr>  <chr>  <chr>     <chr> <chr>       <dbl> <chr>     <chr>      <chr>    
## 1 Gigan… Female green     <NA>  Red          62.5 DC Comics <NA>       bad      
## # … with 1 more variable: weight <dbl>
```
...
##   <chr>       <lgl>   <lgl>               <lgl>              <lgl>              
## 1 Moon Knight FALSE   FALSE               FALSE              FALSE              
