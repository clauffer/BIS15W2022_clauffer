...
ui <- fluidPage(
    ...
    sliderInput("pointsize", "Select the Point Size", min = .25, max = 3, value = 1.5, step = 0.25),
...
ui <- dashboardPage(
  ...
  fluidRow(
  box(
  selectInput("Population", " Select Population of Interest:", choices=unique(wolves$pop)),
  ), # close the first box
