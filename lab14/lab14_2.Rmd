...
swim_carni_qua_ecto_list <- list(swimming_vec, carni_vec, aqua_vec, ecto_vec)

venn_plot <- ggVennDiagram(swim_carni_qua_ecto_list, category.names = c("Swim", "Carnivore", "Aquatic", "Ectotherm"), edge_size = 1.5)

venn_plot +
  scale_fill_distiller(palette = "Greens")+ #distiller is for discrete data
  labs(title = "Can it swim?", "Is it Carnivourous", "Is it Aquatic?", "Is it an ecotherm?",
         caption = ("you can add a caption here, e.g.: Studys show not all birds fly, and not only birds fly")
  )
