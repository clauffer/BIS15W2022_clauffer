...
Below uses the species name Cephalopoda, and below that we use the definition of squid just in case.(I didnt know which defintion we were supposed to use)
