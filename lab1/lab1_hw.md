...
R is a scripting language and Rstudio is a IDE that makes it easier and cleaner to code with R.

Github allows programmers to upload projects or their work, which allows them to collaborate on projects or allow professors to check your work.
